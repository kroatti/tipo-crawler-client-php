...
class SearchApi
{
     ...
     * @return void
     */
    public function apiSearchError500Post()
    {
        $this->apiSearchError500PostWithHttpInfo();
    }
     ...
     */
    public function apiSearchError500PostWithHttpInfo()
    {
        $returnType = '';
        $request = $this->apiSearchError500PostRequest();
    ...
    /**
     * Operation apiSearchError500PostAsync
     *
     * 
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSearchError500PostAsync()
    {
        return $this->apiSearchError500PostAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiSearchError500PostAsyncWithHttpInfo
     *
     * 
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSearchError500PostAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->apiSearchError500PostRequest();
    ...
    /**
     * Create request for operation 'apiSearchError500Post'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiSearchError500PostRequest()
    {

        $resourcePath = '/api/Search/Error500';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
